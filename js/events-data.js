const events = [
...

  {
    ...
    fullDescription:
      "The Post-Exam Hangout is a fun and relaxing social event organized after the examination period. Students will have the opportunity to connect, network, unwind, take photos, play games, share food, and enjoy a stress-free atmosphere after the semester. The event is designed to strengthen friendships and build a stronger Pan-African student community at Istanbul Medipol University.",
